...
class MessageHandler:
    ...
    def serialize_shutdown_message(self, message):
        return message_protocol.internal.serialize(message_protocol.internal.InternalMessageType.GAT_SUM_SHUT, None, None)
